...
/**
 * Alerts Screen (Citizen)
 * Displays flood alerts and warnings
 */
const Alerts = () => {
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyText}>
        You'll be notified when there are flood warnings in your area
      </Text>
    </View>
  );
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Icon name="bell-alert" size={32} color="#0066cc" />
